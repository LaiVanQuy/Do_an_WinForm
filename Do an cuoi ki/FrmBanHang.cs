...
namespace Do_an_cuoi_ki
{
    public partial class FrmBanHang : Form
    {
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            flag = 1;
            if (txtSdtGiamGia.Text != "")
            {
                updateTongTienKH();
                TheDAO.Instance.UpdateLoaiThe();
        ...
        {
            FrmDangKiThe f = new FrmDangKiThe();
            this.Hide();
            f.ShowDialog();
            this.Show();
        }
        ...
        private void pDHoaDon_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Siêu thị Coopmart",
        ...
        private void đổiTrảHàngToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            if (txtSDT.Text == "")
                dtgvThe.DataSource = TheDAO.Instance.LoadThe();
            else
                dtgvThe.DataSource = TheDAO.Instance.TimTheTheoSDT(txtSDT.Text);
        }
        private void btnGiamGia_Click(object sender, EventArgs e)
        {
            if (dtgvThe.CurrentCell==null)
            {
                MessageBox.Show("Chưa chọn thẻ!","Thông báo");
                return;
            }
            string hangthe = dtgvThe.CurrentCell.OwningRow.Cells[3].Value.ToString();
            if (hangthe== "Đồng")
            {
                TongTien = TongTien - TongTien * 3 / 100;
                CultureInfo culture = new CultureInfo("vi-VN");
                txtThanhTien.Text = TongTien.ToString("c", culture);
            }
            if (hangthe == "Bạc")
            ...
            if (hangthe == "Vàng")
            {
                TongTien = TongTien - TongTien * 7 / 100;
                CultureInfo culture = new CultureInfo("vi-VN");
                txtThanhTien.Text = TongTien.ToString("c", culture);
            }
            if (hangthe == "Kim Cương")
            {
        ...
        #endregion
        private void dtgvThe_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            txtSdtGiamGia.Text = dtgvThe.CurrentCell.OwningRow.Cells[0].Value.ToString();
        }
